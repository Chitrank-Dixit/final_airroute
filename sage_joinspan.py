...
# for mailing the password to the email installed the postfix to ubuntu
# usinf the command sudo apt-get install postfix
#
# Whenever write a sage program first import the sage libraries then import the python
...
def main(st):
    ...
    created_graph=extract_distances.get_city_distances('./city_info/city_distances.xls')
    connections=[]
